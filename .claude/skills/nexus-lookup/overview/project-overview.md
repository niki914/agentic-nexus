...
- `a0/a0/a0/a0/a0/a0/Entrance.kt`：Xposed 入口；加载基础 Hook，初始化 repo/runtime，再按宿主路由业务 Hook。
- `com/niki914/nexus/agentic/app/MainActivity.kt`：主 App 入口；计算启动页并在 `onResume()` 刷新远端配置。
