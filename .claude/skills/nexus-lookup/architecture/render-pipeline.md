...
- **会话清理**：通过 `ResetSessionHook` 及浮窗 Detach 事件（700ms 阈值）重置状态。

**源码参考**
- [BreenoChatHook.kt](app/src/main/java/com/niki914/nexus/agentic/mod/feat/oppo/BreenoChatHook.kt)
- [Breeno Subhooks](app/src/main/java/com/niki914/nexus/agentic/mod/feat/oppo/subhooks)
...
- **会话清理**：`ResetSessionHook` 清空当前 Dialog 状态与渲染 Session。

**源码参考**
- [XiaoaiChatHook.kt](app/src/main/java/com/niki914/nexus/agentic/mod/feat/hyper/XiaoaiChatHook.kt)
- [Xiaoai Subhooks](app/src/main/java/com/niki914/nexus/agentic/mod/feat/hyper/subhooks)