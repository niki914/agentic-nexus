...
| `BlockNativeCardHook` | `DataCenter#insertMessage` before | 在 `InjectedLLM` 模式下拦截原生回答卡片 |
...
5. 将增量包装为宿主 `Instruction`，其 `namespace`、`name`、`idPrefix`、终帧补片文本都来自 `XiaoaiConfigProvider`。
